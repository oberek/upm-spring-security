...
/**
 * This class represents the main interface to a password io.smusz.maciej.database.
 * All interaction with the io.smusz.maciej.database file is done using this class.
 */
