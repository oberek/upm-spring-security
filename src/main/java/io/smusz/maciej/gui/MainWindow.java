...
import io.smusz.maciej.platformspecific.PlatformSpecificCode;
...
public class MainWindow extends JFrame implements ActionListener {
	...
	public MainWindow(String title) throws ClassNotFoundException, InstantiationException, IllegalAccessException,
		...
		try {
			// Load the startup io.smusz.maciej.database if it's configured
	...
	private JToolBar createToolBar() {
		...
		// The Sync io.smusz.maciej.database button
